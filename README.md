...
Configure API Keys: Set up your market data and trading API keys in .env.

Train the Model: Run train.py to train or update the AI model.

Start Trading: Execute trade.py to begin live or simulated trading.
